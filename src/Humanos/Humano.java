...
public interface Humano {
    ...
    void M_atacar(ArrayList<Soldados> Soldado, ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    ...
    void M_atacarE(ArrayList<Especialista> Especialista, ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    ...
    void V_atacar(ArrayList<VLigero_H> VLigero_H, ArrayList<Integer> Centro, ArrayList<Integer> Centros);
    
    ArrayList<VPesado_H> V_construccionP(ArrayList<Integer> Centro);
    void V_atacarP(ArrayList<VPesado_H> VPesado_H, ArrayList<Integer> Centro, ArrayList<Integer> Centros);
    //CENTRO DE MANDO
