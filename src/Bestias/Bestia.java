...
public interface Bestia {
    ...
    void M_atacar(ArrayList<Tribu> Tribu, ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    void M_defender(ArrayList<Tribu> Tribu, ArrayList<Integer> Centro);
    
    ArrayList<BestiaMayor> M_entrenarE(ArrayList<Integer> Centro);
    void M_atacarE(ArrayList<BestiaMayor> BestiaMayor, ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    ...
    void V_atacar(ArrayList<VLigero_B> VLigero_B, ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    
    ArrayList<VPesado_B> V_construccionP(ArrayList<Integer> Centro);
    void V_atacarP(ArrayList<VPesado_B> VPesado_B,ArrayList<Integer> Centro,ArrayList<Integer> Centros);
    //CENTRO DE MANDO
